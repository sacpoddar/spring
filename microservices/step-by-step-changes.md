...
(4) Check if you have the right repository url in /spring-cloud-config-server/src/main/resources/application.properties - spring.cloud.config.server.git.uri=file:///sac/git/spring-micro-services/03.microservices/git-localconfig-repo
...
- Group Id: com.sac.microservices
...
#### /limits-service/src/main/java/com/sac/microservices/limitsservice/bean/Limits.java New

```java
package com.sac.microservices.limitsservice.bean;
...
#### /limits-service/src/main/java/com/sac/microservices/limitsservice/controller/LimitsController.java New

```java
package com.sac.microservices.limitsservice.controller;

import org.springframework.web.bind.annotation.GetMapping;
import org.springframework.web.bind.annotation.RestController;

import com.sac.microservices.limitsservice.bean.Limits;
...
#### /limits-service/src/main/java/com/sac/microservices/limitsservice/configuration/Configuration.java New

```java
package com.sac.microservices.limitsservice.configuration;
...
#### /limits-service/src/main/java/com/sac/microservices/limitsservice/controller/LimitsController.java Modified
...
import com.sac.microservices.limitsservice.bean.Limits;
import com.sac.microservices.limitsservice.configuration.Configuration;
...
#### /spring-cloud-config-server/src/main/java/com/sac/microservices/springcloudconfigserver/SpringCloudConfigServerApplication.java Modified
...
spring.cloud.config.server.git.uri=file:///sac/git/spring-microservices-v2/03.microservices/git-localconfig-repo
...
#### /currency-exchange-service/src/main/java/com/sac/microservices/currencyexchangeservice/CurrencyExchange.java New

```java
package com.sac.microservices.currencyexchangeservice;
...
#### /currency-exchange-service/src/main/java/com/sac/microservices/currencyexchangeservice/CurrencyExchangeController.java New
...
#### /currency-exchange-service/src/main/java/com/sac/microservices/currencyexchangeservice/CurrencyExchange.java Modified 
...
- Complete debugging guide for problems with JPA and Hibernate: https://github.com/sac/sac-initiatives/blob/master/The-sac-TroubleshootingGuide-And-FAQ/jpa-and-hibernate.md#tables-are-not-created
...
#### /currency-exchange-service/src/main/java/com/sac/microservices/currencyexchangeservice/CurrencyExchangeController.java Modified
...
#### /currency-exchange-service/src/main/java/com/sac/microservices/currencyexchangeservice/CurrencyExchangeRepository.java New
...
#### /currency-conversion-service/src/main/java/com/sac/microservices/currencyconversionservice/CurrencyConversionController.java New

```java
package com.sac.microservices.currencyconversionservice;
...
#### /currency-conversion-service/src/main/java/com/sac/microservices/currencyconversionservice/CurrencyConversion.java New
...
#### /currency-conversion-service/src/main/java/com/sac/microservices/currencyconversionservice/CurrencyConversionController.java Modified
...
(1) Ensure that you have the annotation @EnableFeignClients with right packages on the class public class CurrencyConversionServiceApplication @EnableFeignClients("com.sac.microservices.currencyconversionservice")
...
#### /currency-conversion-service/src/main/java/com/sac/microservices/currencyconversionservice/CurrencyExchangeProxy.java New
...
#### /naming-server/src/main/java/com/sac/microservices/namingserver/NamingServerApplication.java Modified

- Add @EnableEurekaServer


```java
package com.sac.microservices.namingserver;
...
#### /currency-conversion-service/src/main/java/com/sac/microservices/currencyconversionservice/CurrencyExchangeProxy.java Modified
...
#### /api-gateway/src/main/java/com/sac/microservices/apigateway/ApiGatewayConfiguration.java New

```java
package com.sac.microservices.apigateway;
...
#### /api-gateway/src/main/java/com/sac/microservices/apigateway/LoggingFilter.java New
...
#### /currency-exchange-service/src/main/java/com/sac/microservices/currencyexchangeservice/CircuitBreakerController.java New
...
- (5 Docker Compose Backup Files)[https://github.com/sac/spring-microservices-v2/tree/main/04.docker/backup]
