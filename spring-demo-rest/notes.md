...
class com.sac.spring.demo.rest.helloworld.HelloWorldBean
```
...
public java.lang.String com.sac.spring.demo.rest.helloworld.HelloWorldController.helloWorld()
- Mapped "{[/hello-world-bean],methods=[GET]}" onto 
public com.sac.spring.demo.rest.helloworld.HelloWorldBean com.sac.spring.demo.rest.helloworld.HelloWorldController.helloWorldBean()
- Mapped "{[/error]}" onto 
...
```java
	public static final Contact DEFAULT_CONTACT = new Contact(
			"Sachin", "http://www.sac.example.com", "example@gmail.com");
